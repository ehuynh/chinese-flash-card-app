...
- [x] Update the signout logic to redirect users to the homepage (`/`) after signing out.
- [x] Ensure authentication state is checked on the post-login page and redirect unauthenticated users to the login page or homepage.
- [x] Add navigation (e.g., a button or link) to allow users to sign out from the post-login page.
- [x] Test the login and signout flows to verify correct redirection and authentication state handling.
```
