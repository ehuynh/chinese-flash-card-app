# Remove Placeholder and Template Content

This checklist will guide you through removing all default, placeholder, and template content from the Yika (忆卡) Chinese Flash Card App, such as the default "Create Next App" title and any other boilerplate text or assets left from the Next.js starter template.
...
Refer to this checklist as you work through removing all template and placeholder content from the project.